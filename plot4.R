...
par(mfrow=c(2,2))
#plot1
plot(hpc$datetime,hpc$Global_active_power, type="l", xlab="", ylab="Global Active Power", cex.lab=.8, cex.axis = .8)
#plot2
plot(hpc$datetime,hpc$Voltage, type="l", xlab="datetime", ylab="Voltage", cex.lab=.8, cex.axis = .8)
#plot3
plot(hpc$datetime,hpc$Sub_metering_1, type="l", xlab="", ylab="Energy sub metering", cex.lab=.8, cex.axis = .8)
lines(hpc$datetime,hpc$Sub_metering_2,col="red")
lines(hpc$datetime,hpc$Sub_metering_3,col="blue")
legend("topright", col=c("black","red","blue"), c("Sub_metering_1  ","Sub_metering_2  ", "Sub_metering_3  ")
       ,lty=c(1,1), bty="n", cex=.5)
#plot4
plot(hpc$datetime,hpc$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power", cex.lab=.8, cex.axis = .8)
dev.off()
